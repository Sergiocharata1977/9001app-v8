...
import { initializeFirebaseAdmin, getAdminFirestore, getAdminAuth } from './src/lib/firebase/admin';
...
async function testFirebaseAdmin() {
  ...
  try {
    ...
    console.log('🎉 Your Firebase Admin SDK is properly configured and working.\n');
    ...
    console.error('   1. Verify your .env.local file has the correct credentials');
    console.error('   2. Make sure the private key is properly formatted with \\n characters');
    console.error('   3. Check that the service account has the necessary permissions');
    console.error('   4. Ensure the Firebase project ID matches your actual project\n');
