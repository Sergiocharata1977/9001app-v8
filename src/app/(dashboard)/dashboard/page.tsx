...
export default function Dashboard() {
  ...
  const getGradientClasses = (color: string) => {
    ...
    return (
      gradientMap[color as keyof typeof gradientMap] ||
      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          {metrics.map((metric, index) => (
            <Card
              key={index}
              className="bg-white shadow-md hover:shadow-lg rounded-xl p-4 transition-all duration-200"
            >
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {modules.map((module, index) => {
            const ModuleCard = (
              <Card
                className={`bg-white shadow-md rounded-xl p-6 h-full transition-all duration-300 ${
                  module.enabled
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div
                    className={`w-14 h-14 rounded-xl bg-gradient-to-br ${getGradientClasses(module.color)} flex items-center justify-center shadow-lg ${
