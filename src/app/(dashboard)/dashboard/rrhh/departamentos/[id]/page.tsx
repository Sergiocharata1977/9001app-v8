      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-10 gap-6">
            ...
            <Card className="border-0 shadow-md">
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="text-sm font-medium text-gray-500">Nombre del Departamento</label>
                  ...
                  <div>
                    ...
                    <p className="text-lg font-semibold text-gray-900">{department.responsible_user_id || 'Sin asignar'}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-500">Estado</label>
                    <Badge className={department.is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'}>
                ...
                <div>
                  ...
                  <p className="text-gray-700 mt-1">{department.description || 'Sin descripción disponible'}</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-md">
              ...
              <CardContent>
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500">Lista de empleados del departamento</p>
            ...
            <Card className="border-0 shadow-md">
              ...
              <CardContent>
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500">Lista de puestos del departamento</p>
                  <p className="text-sm text-gray-400 mt-2">Funcionalidad en desarrollo</p>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <Card className="border-0 shadow-md">
              <CardHeader>
                <CardTitle className="text-lg">Objetivos del Departamento</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  <div className="p-3 rounded-lg bg-blue-50">
                    <p className="text-sm font-medium text-blue-900">Mejorar eficiencia operativa</p>
                    <p className="text-xs text-blue-700">Meta: 15% de mejora</p>
                  </div>
                  <div className="p-3 rounded-lg bg-green-50">
                    <p className="text-sm font-medium text-green-900">Reducir costos operativos</p>
                    <p className="text-xs text-green-700">Meta: 10% de reducción</p>
                  </div>
                  <div className="p-3 rounded-lg bg-purple-50">
                    <p className="text-sm font-medium text-purple-900">Aumentar satisfacción del cliente</p>
                    <p className="text-xs text-purple-700">Meta: 90% de satisfacción</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-sm font-semibold text-purple-600">4.2/5</span>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium">Departamento actualizado</p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium">Nuevo gerente asignado</p>
