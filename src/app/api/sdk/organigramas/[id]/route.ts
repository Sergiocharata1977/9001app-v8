...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json(
      { error: 'Error al obtener organigrama', details: error instanceof Error ? error.message : 'Unknown error' },
      { status: 500 }
    );
  }
}
...
export async function PUT(
  ...
  try {
    ...
    return NextResponse.json(
      { error: 'Error al actualizar organigrama', details: error instanceof Error ? error.message : 'Unknown error' },
      { status: 500 }
    );
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json(
      { error: 'Error al eliminar organigrama', details: error instanceof Error ? error.message : 'Unknown error' },
      { status: 500 }
    );
  }
}
