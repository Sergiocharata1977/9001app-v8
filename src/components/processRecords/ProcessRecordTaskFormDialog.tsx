    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Asignado a */}
          <div>
            <Label htmlFor="asignado_a_nombre">Asignado a</Label>
            <Input
              id="asignado_a_nombre"
              value={formData.asignado_a_nombre}
              onChange={e =>
                setFormData({ ...formData, asignado_a_nombre: e.target.value })
              }
