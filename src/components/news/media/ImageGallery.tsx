...
export function ImageGallery({
  ...
  return (
    <>
      <div
        className={`grid gap-2 ${getGridClasses(images.length, maxDisplay)} ${className}`}
      >
        {displayedImages.map((image, index) => (
          <div
            key={image.id}
            className="relative aspect-square overflow-hidden rounded-lg border hover:opacity-80 transition-opacity cursor-pointer"
