...
export function ProcesosAsignadosCard({ procesos, processRecords = [] }: ProcesosAsignadosCardProps) {
    ...
    return (
      <div className="bg-white rounded-lg shadow-md p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-xl font-bold text-gray-900">Procesos Asignados</h2>
        </div>
        <EmptyState
          icon="📋"
            ...
            >
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  ...
                  {proceso.objetivo && (
                    <p className="text-sm text-gray-600 mt-1">{proceso.objetivo}</p>
                  )}
                </div>
                {pendingCount > 0 && (
