...
const navigation: MenuItem[] = [
  ...
  // ===== NUEVO: Configuración Organizacional =====
  {
    name: 'Config. Organizacional',
    href: '/configuracion-organizacional',
    icon: Building,
    children: [
      { name: 'Identidad', href: '/configuracion-organizacional/identidad', icon: Building },
      { name: 'Alcance SGC', href: '/configuracion-organizacional/alcance', icon: Target },
      { name: 'Contexto', href: '/configuracion-organizacional/contexto', icon: Globe },
      { name: 'Estructura', href: '/configuracion-organizacional/estructura', icon: Workflow },
      { name: 'Req. Legales', href: '/configuracion-organizacional/legales', icon: Scale },
    ],
  },
  
  // ===== RENOMBRADO: Planificación y Revisión por Dirección =====
  {
    name: 'Planificación y Revisión',
    href: '/planificacion-revision',
    icon: Award,
    children: [
      ...
      // ❌ ELIMINADOS: Organigramas, Flujogramas, Relación de Procesos (ahora en Estructura)
    ],
  },
  {
    name: 'Mejora',
