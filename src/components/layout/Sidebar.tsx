...
const navigation: MenuItem[] = [
  ...
  { name: 'Módulo Calidad', href: '/dashboard/calidad', icon: Award },
  {
    ...
    icon: Zap,
    children: [
      { name: 'Auditoria', href: '/dashboard/auditorias', icon: Search },
      { name: 'Detección Personal', href: '/dashboard/deteccion-personal', icon: Users },
      { name: 'Satisfacción de Partes', href: '/dashboard/satisfaccion-partes', icon: MessageSquare },
      { name: 'Hallazgos y tratamientos', href: '/dashboard/hallazgos', icon: AlertTriangle },
  ...
  { name: 'CRM', href: '/dashboard/crm', icon: Briefcase },
  {
    ...
    children: [
      ...
      { name: 'Departamentos', href: '/dashboard/rrhh/departments', icon: Building },
      { name: 'Puestos', href: '/dashboard/rrhh/positions', icon: Briefcase },
      { name: 'Personal', href: '/dashboard/rrhh/personnel', icon: UserCheck },
      { name: 'Capacitaciones', href: '/dashboard/rrhh/trainings', icon: GraduationCap },
      { name: 'Evaluaciones', href: '/dashboard/rrhh/evaluations', icon: FileText },
