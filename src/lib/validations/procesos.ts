...
export const processDefinitionFormSchema = processDefinitionSchema.transform((data) => ({
  ...data,
...
export type ProcessDefinitionFilters = z.infer<typeof processDefinitionFiltersSchema>;
